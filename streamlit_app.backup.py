...
def generate_simple_quiz(text_content, unit_title, difficulty):
    ...
    quiz_questions = {
        "Unit 1 - Greeting": {
            "Beginner": [
                {
                    "question": "John의 이름은 무엇입니까?",
                    "options": ["John", "Jane", "James"],
                    "answer": 0
                },
                {
                    "question": "John은 어디에서 왔습니까?",
                    "options": ["New York", "London", "Tokyo"],
                    "answer": 0
                },
                {
                    "question": "지문의 주제는 무엇입니까?",
                    "options": ["인사", "여행", "음식"],
                    "answer": 0
                }
            ],
            "Intermediate": [
                {
                    "question": "John이 New York에서 온 것을 어떻게 알 수 있습니까?",
                    "options": ["지문에 명시됨", "그림으로 표시됨", "맥락에서 추론함"],
                    "answer": 0
                },
                {
                    "question": "지문에서 사용된 표현 중 가장 격식적인 것은?",
                    "options": ["Hello", "Nice to meet you", "How are you"],
                    "answer": 1
                },
                {
                    "question": "이 대화의 상황은 어디인가?",
                    "options": ["학교", "처음 만나는 자리", "사무실"],
                    "answer": 1
                }
            ],
            "Advanced": [
                {
                    "question": "지문에서 사회적 에티켓을 반영하는 표현은?",
                    "options": ["자기소개와 상대방 안부 묻기", "경제적 배경 언급", "정치적 의견 표현"],
                    "answer": 0
                },
                {
                    "question": "John의 표현 방식에서 드러나는 태도는?",
                    "options": ["공격적", "친절하고 개방적", "의심적"],
                    "answer": 1
                },
                {
                    "question": "이 대화에서 '지역적 정체성'이 중요한 이유는?",
                    "options": ["경제적 이익", "상호 이해와 관계 형성", "학문적 관심"],
                    "answer": 1
                }
            ]
        },
        "Unit 2 - Family": {
            "Beginner": [
                ...
                {
                    "question": "가족 구성원은 몇 명?",
                    "options": ["3명", "4명", "5명"],
                    "answer": 2
                },
                {
                    "question": "가족이 사는 곳은?",
                    "options": ["작은 집", "큰 집", "아파트"],
                    "answer": 1
                }
            ],
            "Intermediate": [
                {
                    "question": "부모님의 직업이 지문에서 강조하는 이유는?",
                    "options": ["수입 자랑", "가족의 역할 설명", "대비"],
                    "answer": 1
                },
                {
                    "question": "'close-knit family'의 의미는?",
                    "options": ["큰 집에 사는 가족", "긴밀한 관계의 가족", "많은 돈을 버는 가족"],
                    "answer": 1
                },
                {
                    "question": "지문의 전체 톤은?",
            ...
            "Advanced": [
                {
                    "question": "가족 구조 표현의 형식성 수준 변화는?",
                    "options": ["고급 → 기초", "기초 → 고급", "일정"],
                    "answer": 1
                },
                {
                    "question": "직업 언급이 문화적으로 의미하는 바는?",
                    "options": ["개인 정체성", "사회적 지위", "가족 가치관"],
                    "answer": 2
                },
                {
                    "question": "세 난이도 지문의 공통점은?",
                    "options": ["같은 메시지 전달", "다른 주제", "반대 입장"],
                    "answer": 0
                }
            ]
        }
    ...
    if unit_title not in quiz_questions:
        return [
            {
                "question": f"{unit_title}의 주요 주제는 무엇입니까?",
                "options": ["선택지 1", "선택지 2", "선택지 3"],
                "answer": 0
            },
            {
                "question": "지문의 핵심 내용은?",
                "options": ["내용 1", "내용 2", "내용 3"],
                "answer": 0
            },
            {
                "question": "이 주제와 관련하여 중요한 것은?",
                "options": ["관점 1", "관점 2", "관점 3"],
                "answer": 0
            }
        ]
...
def show_step3_activity(selected_mission):
    ...
    if selected_mission == "image_detective":
        st.write("📷 **그림을 보고 단어를 맞춰보세요!**")
        st.info("(데모용 이미지 플레이스홀더)")
        answer = st.text_input("정답을 입력하세요:", key="image_detective_answer")
        if st.button("정답 제출하기", use_container_width=True, key="submit_image"):
